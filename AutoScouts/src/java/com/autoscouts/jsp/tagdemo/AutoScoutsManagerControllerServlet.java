...
@WebServlet(name = "AutoScoutsManagerControllerServlet", urlPatterns = {"/AutoScoutsManagerControllerServlet"})
public class AutoScoutsManagerControllerServlet extends HttpServlet {
private ProductInventoryDbUtil productInventoryDbUtil;
    ...
    public void verifyCreditCard(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        
    }
    
    public void verifyDebitCard(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
